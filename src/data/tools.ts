...
export const tools: Tool[] = [
  ...
  },
  {
    id: 'dynamitelab',
    name: 'DynamiteLab',
    description: 'DynamiteLab delivers the easiest way to explore network behavior from packet captures. The platform is a successor to PacketTotal with over 100,000 PCAP files in its repository, allowing to research and publicly share traffic samples.',
    category: 'network-analysis',
    pricing: 'free',
    website: 'https://dynamitelab.com/',
    features: ['PCAP analysis', 'Network behavior exploration', '100,000+ PCAP repository', 'Public traffic samples'],
  },
  {
    id: 'tshark',
    name: 'Tshark',
    description: 'tshark (Terminal wireSHARK) is the command line tool (CLI) that has most, but not all, of the features of Wireshark. What features tshark lacks is often found in other CLI tools that are bundled with Wireshark.',
    category: 'network-analysis',
    pricing: 'free',
    website: 'https://tshark.dev/',
    features: ['Command-line interface', 'Wireshark features', 'Network packet analysis', 'CLI tools integration'],
  },
  {
    id: 'tcpick',
    name: 'tcpick',
    description: 'tcpick is a textmode sniffer; it tracks tcp streams, shows the status, reassembles and saves the data captured in files or displays them in the terminal in different modes (ascii, hex..). There is a color-mode. Useful to get files passively.',
    category: 'network-analysis',
    pricing: 'free',
    website: 'https://sourceforge.net/projects/tcpick/',
    features: ['TCP stream tracking', 'Data reassembly', 'Multiple display modes', 'File extraction'],
  },
  {
    id: 'pcapsipdump',
    name: 'pcapsipdump',
    description: 'pcapsipdump is libpcap-based SIP sniffer with per-call sorting capabilities. It writes SIP/RTP sessions to disk in a same format, as "tcpdump -w", but one file per SIP session (even if there is thousands of concurrent SIP sessions).',
    category: 'network-analysis',
    pricing: 'free',
    website: 'https://pcapsipdump.sourceforge.net/',
    features: ['SIP sniffer', 'Per-call sorting', 'RTP session capture', 'Session separation'],
  },
  {
    id: 'netsnake-sniffer',
    name: 'netsnake-sniffer',
    description: 'This utility allows you to capture network packets on the selected network interface. A chart o the volume of transmitted and received packets is displayed. It has an ability to filter intercepted packets by source ip,source port, destination ip,destination port, type of protocol and length packets.',
    category: 'network-analysis',
    pricing: 'free',
    website: 'https://sourceforge.net/projects/netsnake-sniffer/#',
    features: ['Packet capture', 'Traffic visualization', 'Packet filtering', 'Custom packet sending'],
  },
  {
    id: 'nast',
    name: 'Nast (Network Analizer Sniffer Tool)',
    description: 'Nast is a packet sniffer and a LAN analyzer. It sniff packets and save data in files, checks NIC in promisc mode,build LAN hosts list, find a gw,performs a port scanning, catchs daemon banner etc... It also provides a GTK/ncurses interface.',
    category: 'network-analysis',
    pricing: 'free',
    website: 'https://sourceforge.net/projects/nast.berlios/',
    features: ['Packet sniffing', 'LAN analysis', 'Port scanning', 'GTK/ncurses interface'],
  },
  {
    id: 'slsnif',
    name: 'Serial line sniffer',
    description: 'Serial line sniffer (slsnif). slsnif is a serial port logging utility. It listens to the specified serial port and logs all data going through this port in both directions.',
    category: 'network-analysis',
    pricing: 'free',
    website: 'https://sourceforge.net/projects/slsnif/',
    features: ['Serial port logging', 'Bidirectional monitoring', 'Data logging', 'Port monitoring'],
  },
